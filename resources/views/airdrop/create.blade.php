<x-app-layout>
    <x-slot name="header">
        <h1>Add Airdrop 🎁</h1>
        <p>Create a new airdrop project</p>
    </x-slot>
    ...
    <div class="form-container">
        ...
        <div class="form-section">
            <form action="{{ route('airdrop.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- Project Name -->
                <div class="form-group">
                    <label for="name">Project Name *</label>
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g., Ethereum Airdrop">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="link" name="link" value="{{ old('link') }}" required placeholder="https://example.com">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="chain" name="chain" value="{{ old('chain') }}" required placeholder="e.g., Ethereum, Polygon, Arbitrum">
                    @error('chain')
                        <div class="error-text">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="task_type" name="task_type">
                        ...
                        <option value="testnet" {{ old('task_type') === 'testnet' ? 'selected' : '' }}>🧪 Testnet</option>
                        <option value="retro" {{ old('task_type') === 'retro' ? 'selected' : '' }}>⏮️ Retro</option>
                        <option value="node" {{ old('task_type') === 'node' ? 'selected' : '' }}>🖥️ Node</option>
                        <option value="mining" {{ old('task_type') === 'mining' ? 'selected' : '' }}>⛏️ Mining</option>
                        <option value="social_task" {{ old('task_type') === 'social_task' ? 'selected' : '' }}>📱 Social Task</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Describe the airdrop project...">{{ old('description') }}</textarea>
                ...
                <div style="border-top: 2px solid var(--border-light); padding-top: 1.5rem; margin-top: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="discord_link" name="discord_link" value="{{ old('discord_link') }}" placeholder="https://discord.gg/...">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="twitter_link" name="twitter_link" value="{{ old('twitter_link') }}" placeholder="https://x.com/...">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="telegram_link" name="telegram_link" value="{{ old('telegram_link') }}" placeholder="https://t.me/...">
                ...
                <div style="border-top: 2px solid var(--border-light); padding-top: 1.5rem; margin-top: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="wallet_address" name="wallet_address" value="{{ old('wallet_address') }}" placeholder="0x...">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="private_key" name="private_key" placeholder="Enter private key..." style="font-family: monospace; font-size: 12px;">{{ old('private_key') }}</textarea>
                ...
                <div style="border-top: 2px solid var(--border-light); padding-top: 1.5rem; margin-top: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="notes" name="notes" placeholder="Add progress notes, tasks completed, issues encountered, etc..." style="min-height: 150px;">{{ old('notes') }}</textarea>
